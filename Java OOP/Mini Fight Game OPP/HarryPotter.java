...
Date: 2020.11.20
Description: Harry Potter is one of the characters that extedns Character class.
It has 10 SP, 0 A, and 2d6 attack, 2d6 defense as a default. It can revive 
once if it dies, ant it revives with a SP of 20.
*******************************************************************************/
class HarryPotter extends Character{
   //constructor for Harry Potter
   public HarryPotter(){
      strengthPoints = 10;
      armor = 0;
      chance = 1;
